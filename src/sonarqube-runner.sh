...
dotnet sonarscanner begin /o:$Ogr /k:$Sonar_Project /d:sonar.host.url=$Sonar_Url  /d:sonar.cpd.exclusions="**/Migrations/*.cs" /d:sonar.cs.opencover.it.reportsPaths="$PWD/coverage.opencover.xml"
dotnet build
